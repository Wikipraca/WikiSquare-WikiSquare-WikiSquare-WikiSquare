...
class DiamondBL {
	...
	{		
		...
		$output .= $this->render_output($wgt_miss, $wgt_count, $wgt_format, $wgt_avsize, $wgt_defav, $wgt_dt, '<li id="rotator" class="flag_widget">', '</li>', '<ul>', '</ul>', $wgt_mtext, $diamond_bloglist_order, $diamond_bloglist_order_by, $wgt_white, $min_post_count, $comment_age) ;
