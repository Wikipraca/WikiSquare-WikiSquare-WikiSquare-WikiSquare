...
< a href="<strong>Your Social Network Link</strong>" title="<strong>Your Social Network Title</strong>" >< img src="<strong>Your Selected Image</strong>" alt="<strong>Your Social Network Title</strong>" /></ a>
...
2. Upload `add-my-network-widget` directory to the `/wp-content/plugins/` directory
